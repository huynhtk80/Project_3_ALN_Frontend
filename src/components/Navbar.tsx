        ...
        {({ open, onToggle }) => (
          <>
            <div className='relative flex h-16 items-center justify-between text-base-content '>
              {/* Mobile menu button*/}
              <Disclosure.Button
                className='inline-flex items-center justify-center rounded-md p-2 text-base-content hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white'
                onClick={onToggle}
              >
