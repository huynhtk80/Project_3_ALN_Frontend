    ...
    >
      <div className='modal-content bg-primary text-lg p-4 rounded-lg bg-opacity-80 '>
        <div className='order-2 border-solid rounded-lg border-primary bg-primary-focus bg-opacity-80 shadow-lg p-5 w-96'>
          ...
          >
            <button
              className='btn btn-md btn-block  bg-neutral text-base-300 text-4xl  tracking-widest  transition-all duration-300 mb-3'
        ...
        <ul>
          <li>
            <Link to={'/Home/Category/Film/' + CountryName}>
              <button
                className='btn btn-sm m-1 text-white bg-neutral transition-all duration-300'
                onClick={() => setShowModal(false)}
              >
                Film
              </button>
        ...
        <div className='justify-end flex'>
          <button
            className='btn btn-xs  text-white bg-neutral transition-all duration-300'
            onClick={() => setShowModal(false)}
          >
            X
          </button>
