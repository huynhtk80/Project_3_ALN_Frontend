                  ...
                  <fieldset>
                    ...
                    <div className="mt-4 space-y-4">
                      <div className="flex items-center">
                        ...
                        />
                        <label htmlFor="travel" className="ml-3 block text-sm font-medium text-gray-700">
                          Travel
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500"
                        />
                        <label htmlFor="music" className="ml-3 block text-sm font-medium text-gray-700">
                          Music
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500"
                        />
                        <label htmlFor="current-events" className="ml-3 block text-sm font-medium text-gray-700">
                          Current Events
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500"
                        />
                        <label htmlFor="investment" className="ml-3 block text-sm font-medium text-gray-700">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500"
                        />
                        <label htmlFor="fullLength" className="ml-3 block text-sm font-medium text-gray-700">
                          Full-Length Movies
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500"
                        />
                        <label htmlFor="documentaries" className="ml-3 block text-sm font-medium text-gray-700">
                          Documentaries
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500"
                        />
                        <label htmlFor="short-films" className="ml-3 block text-sm font-medium text-gray-700">
                          Short Films
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500"
                        />
                        <label htmlFor="networking" className="ml-3 block text-sm font-medium text-gray-700">
                          Networking
                        </label>
                      </div>
                    </div>
