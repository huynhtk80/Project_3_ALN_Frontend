function PrivacyPolicy() {
  return (
    <div className='text-base-100 card-bordered shadow-xl bg-neutral rounded-lg pb-5 px-5 mx-auto mt-20 mb-10'>
      <h1 className='grid justify-center text-3xl font-bold pt-5'>
        Privacy Policy
      </h1>
      <br />
      <p className='grid justify-items-center mx-3'>
        ...
        * Vital Interests. We may process your information where we believe it
        ...
        purpose, or insinuations where your permission can be inferred (i.e.,
        ...
        * Offer Wall. Our application(s) may display a third-party hosted
        ...
        make public on such asocial media platform.
        <br />
        ...
        third- party social media provider. <br />
        <br />
        <br />
        <br />
        <br />
        Privacy Policy Cookie Policy Terms and Conditions you review their
        ...
        <br /> However, despite our safeguards and efforts to secure your
        information, nonelectronic transmission over the Internet or information
        ...
        collect, access, steal, or modify your information. <br />
        ...
        to children under 18 years of age. Busing the Services, you represent
        ...
        <br /> If we learn that personal information from users less than 18
        ...
        age 18, please contact us atinfo@africalivenetwork.tv.
        <br />
        <br />
        <br />
        <br />
        ...
        <br /> you have certain rights under applicable data protection laws.
        These may include the right <br />
        (i) to request access and obtain a copy of your personal information,
        <br /> (ii) to request rectification or erasure;
        <br /> (iii)to restrict the processing of your personal information;{' '}
        <br />
        ...
        information. You can make such a request by contacting2/18/23, 9:15 AM
        Termly
        https://app.termly.io/dashboard/website/a37d4b17-4f66-451d-8d0e-b8e0969b867b/privacy-
        policy 8/14
        <br />
        <br />
        EULA Return Policy Disclaimer Shipping Policy Acceptable Use Policy
        Settings
        <br />
        us by using the contact details provided in the section &quot;HOW CAN
        YOU CONTACTUS ABOUT THIS NOTICE?&quot; below.
        <br />
        ...
        authority.
        <br /> You can find their contact details
        here:https://ec.europa.eu/justice/data-
        ...
        ABOUT THIS NOTICE?
        <br /> “below or updating your preferences. However, please note that
        ...
        email us atinfo@africaivenetwork.tv.
        <br />
        <br />
        <br />
        <br />
        ...
        outside testate of California for a temporary or transitory purpose
        <br />
        ...
        <br />
        <br />
        C. Protected classification characteristics under Gender and date of
        birth
        <br />
        YES
        <br />
        California or federal law D. Commercial information
        <br />
        ...
        * Participation in customer surveys or contests;
        ...
        <br />
        You may contact us by email at info@africalivenetwork.tv, or by
        ...
        <br />
        Afrcia Live Network Inc. has not disclosed, sold, or shared any personal
        ...
        <br />
        <br />
        months.Africa Live Network Inc. will not sell or share personal
        ...
        If you ask us to delete your personal information, we will respect your
        ...
        * the specific pieces of personal information we collected about you.
        ...
        Rights We will not discriminate against you if you exercise your privacy
        ...
        * You may request to opt out from future selling or sharing of your
        ...
        info@africalivenetwork.tv, Or by referring to the contact details at the
        ...
        information.
        <br />
        Virginia CDPA Privacy Notice Under the Virginia Consumer Data Protection
        Act (CDPA):
        <br />
        ...
        for monetary consideration. If this definition &quot;consumer&quot;
        ...
        * that produce legal or similarly significant effects
        ...
        <br />
        <br />
        Africa Live Network Inc. has not sold any personal data to third parties
        for business or commercial purposes. Africa Live Network Inc. will not
        sell personal data in the future belonging to website visitors, users,
        and other consumers.
        <br />
        Exercise your rights provided under the Virginia CDPA More information
        about our data collection and sharing practices can be found in this
        privacy notice
        <br />
        You may contact us by email at info@africaivenetwork.tv, by visiting our
        data subject request form, or by referring to the contact details at the
        ...
        all cases, within forty- five (45) days of receipt. <br />
        ...
        <br /> If you wish to appeal our decision, please email us at
        info@africaivenetwork.tv .<br />
        <br />
        ...
        your appeal if denied, you may contact the Attorney General to submit a
        complaint .
        <br />
        <br />
        <br />
        ...
        <br /> If we make material changes to this privacy notice, we may notify
        ...
        <br /> or by post to:
        <br />
        Africa Live Network Inc.
        <br />
        Grand Terrace Office and Studios
        <br />
        Des Moines,IA 2323
        <br />
        United States
