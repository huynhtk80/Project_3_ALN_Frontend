  ...
  return (
    <div className='text-base-100 card-bordered shadow-xl bg-neutral pb-5 m-20 rounded-lg'>
      ...
      <div className='grid justify-items-start container mx-auto px-4 mb-10'>
        ...
        like to shoot productions in any part of the continent that interests
        them by building the necessary data and research so that by the time the
        film crew arrives, there will be all the necessary resources available
        ...
        continent in stimulating economic growth by promoting tourism through
        high quality videos that highlight the different beauties in and around
